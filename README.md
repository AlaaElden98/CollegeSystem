...
* Android Studio can download from here [Android studio](https://developer.android.com/studio) .
* Google acount [Google](https://myaccount.google.com/?tab=kk) .
* Firebase Runtime and connect with our poroject .
...
To insure you can use our app .. you must donload standar data .
it's data come from Ministry of education .
this data contain national ID and seating number of each student .
...
* our app build by one activity only and alot of fragmen .
...
### our app split into three parts (Admin , Doctors , Student)
    ...
    - After import the database you will find nationlID and password For each of them 
...
3 - min total (minmun number of toatal degree) .

4 - min special (it's an optional field , the codition if degree in specific subject < the degree of student have) .

5 - description of this subject that student should kown.
...
# 2 - Authorities of the doctors part

before login as a doctor
...
## Add new Question screen contain
...
# 3 - Authorities of the student part
...
## Recording desires and choose department

* this is the most important part on the application.

1 - using dynamic recylerView that can allow user to drag and drop , UP and Down to arrange his desires by modern way.

2 - Before click on the button we fetch his degree at high scoole And choose the appropriate department.
